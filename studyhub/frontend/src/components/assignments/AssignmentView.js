                ...
                <div className="w-64 bg-white dark:bg-zinc-800 shadow-lg dark:shadow-zinc-900/50 overflow-y-auto">
                    ...
                    <nav className="p-2">
                        <button
                            ...
                            className="w-full text-left p-2 rounded transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200"
                        >
                            Course Introduction
                        </button>
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left p-2 pl-6 text-sm transition-colors ${
                                            assignment.id.toString() === assignmentId
                                                ...
                                                : 'text-green-600 dark:text-green-500 hover:bg-zinc-50 dark:hover:bg-zinc-700'
                                        }`}
                                    >
                                        📝 {assignment.title}
                                    </button>
