                    ...
                    <div className="p-7">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={loading}
                                        className="w-full px-3 py-2.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 rounded-md focus:ring-zinc-300 dark:focus:ring-zinc-100 focus:border-transparent transition-all duration-200"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full px-4 py-3 text-white dark:text-zinc-900 font-medium bg-zinc-800 dark:bg-white rounded-md hover:bg-zinc-700 dark:hover:bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-zinc-900 transition-all duration-200 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
                                {loading ? (
